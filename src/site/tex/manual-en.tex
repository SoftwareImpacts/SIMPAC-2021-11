...
The result is displayed in a new vector layer containing for each link of the selected linkset a polygon representing its corridor. Links with a distance greater than $d_{max}$ will have no corridor.
...
\subsubsection{Flow Probability of Connectivity}
\label{metric_FPC}
\begin{table}[H]
\begin{tabular}{|m{3.24cm}|m{4.4810004cm}m{7.924cm}|}
\hline
Flow Probability of Connectivity
($FPC$) &
\multicolumn{1}{m{4.4810004cm}|}{Formula} &
Meaning\\\hline
Local level &
