...
Le résultat s'affiche dans une nouvelle couche vectorielle qui contient pour chaque lien du jeu de liens sélectionné un polygone représentant son corridor. Les liens ayant une distance supérieure à $d_{max}$ n'auront pas de corridor.

L'affichage par défaut utilise la transparence pour faire apparaître les superpositions de corridors.
