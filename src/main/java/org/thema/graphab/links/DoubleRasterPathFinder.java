 ...
 */
public final class DoubleRasterPathFinder implements RasterPathFinder {
     ...
     * @throws IOException 
     */
    public DoubleRasterPathFinder(Project prj, Raster codeRaster, double [] cost, double coefSlope) throws IOException {
        this.project = prj;
     ...
     * @throws IOException 
     */
    public DoubleRasterPathFinder(Project prj, Raster costRaster, double coefSlope) throws IOException {
