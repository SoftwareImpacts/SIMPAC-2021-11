...
public class PointsetDataDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("PointsetDataDialog.title")); // NOI18N

        java.util.ResourceBundle bundle1 = java.util.ResourceBundle.getBundle("org/thema/graphab/pointset/Bundle"); // NOI18N
        okButton.setText(bundle1.getString("PointsetDataDialog.okButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle1.getString("PointsetDataDialog.cancelButton.text")); // NOI18N
        ...
        jLabel1.setText(bundle1.getString("PointsetDataDialog.jLabel1.text")); // NOI18N

        jLabel2.setText(bundle1.getString("PointsetDataDialog.jLabel2.text")); // NOI18N

        nameTextField.setColumns(5);
        nameTextField.setText(bundle1.getString("PointsetDataDialog.nameTextField.text")); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle1.getString("PointsetDataDialog.jPanel2.border.title"))); // NOI18N

        jLabel3.setText(bundle1.getString("PointsetDataDialog.jLabel3.text")); // NOI18N

        maxSpinner.setModel(new javax.swing.SpinnerNumberModel(Double.valueOf(0.0d), Double.valueOf(0.0d), null, Double.valueOf(1.0d)));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(maxSpinner, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
                .add(50, 50, 50))
        );
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(cancelButton))
                    .add(distComboBox, 0, 238, Short.MAX_VALUE))
                .addContainerGap())
        );
